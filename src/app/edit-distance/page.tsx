    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold py-2.5 px-4 rounded-lg transition-all active:scale-95"
        >
          {isRunning ? (
        ...
        <button
          onClick={handleReset}
          className="px-4 py-2.5 rounded-lg border border-[#2e2e3e] text-slate-400 text-sm hover:bg-[#1e1e2e] hover:text-white transition-all active:scale-95"
        >
          Reset
        </button>
      </div>
